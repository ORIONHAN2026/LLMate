import 'dart:convert';
import 'dart:async';
import 'package:chathub/models/bigmodel/qwen_response.dart';
...
class QwenProvider extends BaseLlmProvider {
  ...
  Stream<Map<String, String?>> _transformStreamResponse(
    ...
    await for (final chunk in stream) {
      ...
      for (final line in lines) {
        ...
        try {
          final response = QwenResponse.fromJson(
  ...
  Future<Map<String, dynamic>?> getModelInfo() async {
    ...
    return {
      ...
      'configured': true,
      'supports_reasoning': model!.model.contains('qwq'),
    };
  }
}
