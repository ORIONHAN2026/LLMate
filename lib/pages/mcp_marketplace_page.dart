...
class _McpMarketplacePageState extends State<McpMarketplacePage> {
  ...
  static const List<_MarketItem> _allItems = [
    ...
    _MarketItem(
      ...
      command: 'npx',
      args: ['-y', '@modelcontextprotocol/server-redis', '--uri', 'redis://localhost:6379'],
      category: '数据库',
    ...
    _MarketItem(
      ...
      command: 'npx',
      args: ['-y', '@modelcontextprotocol/server-brave-search', '--api-key', 'YOUR_KEY'],
      category: '网络工具',
  ...
  Future<void> _saveModel(ChatModel updatedModel) async {
    ...
    if (session != null) {
      sessionController.updateSession(session.copyWith(chatModel: updatedModel));
    }
                  ...
                  SizedBox(
                    ...
                    child: isAdded
                        ...
                        : FilledButton.icon(
                            onPressed: isSheetConnecting ? null : () async {
                              try {
                                ...
                                try {
                                  ...
                                  if (model != null && ctx.mounted) {
                                    await _saveModel(model.addMcpService(realConfig));
                                    if (mounted) setState(() {});
                                    Navigator.pop(ctx);
                            ...
                            label: Text(isSheetConnecting ? '连接中...' : '连接并添加'),
          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('请先选择会话并绑定模型', style: TextStyle(fontSize: 14, color: Colors.grey[500])),
                ],
              ),
            )
          : Column(
              children: [
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return FilterChip(
                              ...
                              selected: sel,
                              onSelected: (_) { _selectedCategory = c; _filter(); },
                ...
                Expanded(
                  child: _filteredItems.isEmpty
                      ? Center(child: Text('没有找到相关服务', style: TextStyle(fontSize: 14, color: Colors.grey[500])))
                      : ListView.builder(
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(item.category, style: TextStyle(fontSize: 10, color: Colors.grey[600])),
                        ),
                      ],
                    ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(
                    ...
                    size: 14,
                    color: isAdded ? Theme.of(context).colorScheme.primary : Colors.grey[500],
                  ),
                ),
              ),
            ],
